...
# this is a fail safe in case the user forgets to include the contents section in the prompt. The code will not break and will simply use this default contents section.    